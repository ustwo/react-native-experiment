/**
 * NOTE: This is effectively a copy of the MapMarker component in react-native-maps,
 *       the only difference being the file location of decorateMapComponent.
 */
...
module.exports = decorateMapComponent(Marker, {
